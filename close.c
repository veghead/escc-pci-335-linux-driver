 ...
 *
 * close.c -- close (release) function for escc-pci module
 *
 * Tested with Linux version 2.2 12
 ******************************************************/

/* $Id: close.c,v 1.4 2004/10/18 17:21:16 carl Exp $ */
...
{
Escc_Dev * dev;
dev = (Escc_Dev*)filp->private_data;
PDEBUG("%u CLOSE\n",dev->dev_no);
dev->escc_u_count--;//dec usage count
